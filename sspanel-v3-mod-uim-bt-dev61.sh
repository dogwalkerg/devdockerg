...
wget -N --no-check-certificate "https://raw.githubusercontent.com/dogwalkerg/devdockerg/master/dev61.zip"
unzip dev61.zip
cd ss-panel-v3-mod_Uim-dev61
mv * .[^.]* /www/wwwroot/$website/
cd ..
rm -rf dev61.zip ss-panel-v3-mod_Uim-dev61/
